...
public class Day_14 : AoCBaseDay<int, int, List<(int x, int y)>>
{
    ...
    public override AoCSolution<int, int> Solve(AoCResourceType resourceType)
    {
        ...
        List<(int x, int y)> coordPairs = Helpers.FileCleanReadText(FileDescription(this, resourceType))
            .Replace("\n", "_")
            .Replace(" -> ", "_")
            .Split('_')
    ...
    private LegacyGrid<string> BuildCave(List<(int x, int y)> coordPairs, AoCResourceType resourceType, out LegacyCoordinates pour)
    {
        ...
        var rockPaths = Helpers.FileCleanReadText(FileDescription(this, resourceType)).Replace(" -> ", "_")
